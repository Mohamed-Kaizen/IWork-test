"""Django base settings for IWrok Test project."""
import pathlib
...
ROOT_URLCONF = "iwrok_test.urls"

# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "iwrok_test.wsgi.application"
...
MIDDLEWARE = [
    ...
    "user_g11n.middleware.UserLanguageMiddleware",  # django-user-g11n
    "user_g11n.middleware.UserTimeZoneMiddleware",  # django-user-g11n
]
...
# ------------------------------------------------------------------------------
AXES_COOLOFF_TIME = (
    timezone.timedelta(minutes=5) if DEBUG else timezone.timedelta(minutes=60)
)
